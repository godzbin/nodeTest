(function () {
  var defaultData = {
    pay_json: { "coinPrice": 200, "coinNum": 1, "fee": [{ "pulseNum": 8, "fee": 500, "count": 8, "feeStatus": 1 }, { "pulseNum": 7, "fee": 400, "count": 8, "feeStatus": 1 }, { "pulseNum": 6, "fee": 300, "count": 8, "feeStatus": 1 }, { "pulseNum": 8, "fee": 500, "count": 8, "feeStatus": 1 }] },
  ...
  Pay.prototype = {
    ...
    init: function () {
      this.fee = {
        fee: this.data.coinPrice,
        pulseNum: this.data.pulseNum
      };
      this.cachePage();
      this.addEvent();
      this.getFeeList();
    ...
    showConfirmPayWin: function () {
      this.confirmPayWin.style.display = "block";
    ...
    hideConfirmPayWin: function () {
      this.confirmPayWin.style.display = "none";
    },
